...
class DecimalMinutes(DecimalDegree):
    ...
    def __init__(self , long, lat):
        ...
        #print(in_coords2)
       #Here is the inherited class call...
        DecimalDegree.__init__(self, long, lat)  
        
class DegreesMinutesSeconds(DecimalDegree):
    '''takes degrees, minutes, and seconds as tuples (or lists) and converts them to other formats'''
    def __init__(self , long, lat):
        self.longdeg = long[0]
        self.longmin = long[1]
        self.longsec = long[2]
        ...
        long = long_scaler * round(abs(self.longdeg) + self.longmin/60 + self.longsec/3600,6)
        lat =lat_scaler * round(abs(self.latdeg) + self.latmin/60 + self.latsec/3600,6)
        DecimalDegree.__init__(self, long, lat)
